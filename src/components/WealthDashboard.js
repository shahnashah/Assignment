...
//               className={`w-180 px-4 py-2 border rounded text-sm transition-colors duration-300 ${
//                 darkMode 
...
//             darkMode ? 'text-gray-300 hover:text-white' : 'text-gray-600 hover:text-gray-800'
//           }`} />
//           <Star className={`w-5 h-5 cursor-pointer transition-colors duration-300 ${
//             darkMode ? 'text-gray-300 hover:text-white' : 'text-gray-600 hover:text-gray-800'
//           }`} />
//           <Users className={`w-5 h-5 cursor-pointer transition-colors duration-300 ${
//             darkMode ? 'text-gray-300 hover:text-white' : 'text-gray-600 hover:text-gray-800'
//           }`} />
//           <Search className={`w-5 h-5 cursor-pointer transition-colors duration-300 ${
//             darkMode ? 'text-gray-300 hover:text-white' : 'text-gray-600 hover:text-gray-800'
//           }`} />
//           <Lock className={`w-5 h-5 cursor-pointer transition-colors duration-300 ${
//             darkMode ? 'text-gray-300 hover:text-white' : 'text-gray-600 hover:text-gray-800'
//           }`} />
...
//             {/* <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-white text-xs font-bold">G</div> */}
...
//             <div key={index} className="py-3 cursor-pointer hover:bg-red-700 px-2 transition-colors duration-200 flex items-center">
//               <span>{item}</span>
...
//                 <div className="text-3xl font-bold">AUM 12.19 <span className="text-lg">Cr</span></div>
//                 <div className="flex items-center text-green-600 text-sm mt-2">
//                   <ArrowUp className="w-4 h-4 mr-1" />
//                   <span>+0.77% MoM</span>
//                 </div>
//               </div>
//               <button className="text-red-500 border border-red-500 px-3 py-1 rounded text-xs hover:bg-red-50 transition-colors duration-200">
//                 View Report
//               </button>
//             </div>
...
//               <div>
//                 <div className={`text-sm mb-2 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Current</div>
//                 <div className="text-3xl font-bold">SIP 1.39 <span className="text-lg">Lakh</span></div>
//                 <div className="flex items-center text-green-600 text-sm mt-2">
//                   <ArrowUp className="w-4 h-4 mr-1" />
//                   <span>+0% MoM</span>
//                 </div>
...
//         {/* Filter Buttons with Refresh Functionality */}
...
//               icon: () => (
//                 <div className="w-8 h-8 bg-red-100 rounded flex items-center justify-center">
//                   {/* Hand with money/transaction icon */}
//                   <div className="relative">
//                     <div className="w-3 h-2 bg-red-500 rounded-sm mb-1"></div>
//                     <div className="w-1 h-2 bg-red-500 rounded-full mx-auto"></div>
...
//               icon: () => (
//                 <div className="w-8 h-8 bg-red-100 rounded flex items-center justify-center">
//                   {/* Rejection/cancel icon with curves */}
...
//             return (
//               <div key={index} className={`p-4 rounded-lg shadow-sm transition-colors duration-300 ${
//                 darkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'
//               }`}>
...
//                     <div className="text-sm font-medium">{stat.amount}</div>
//                   </div>
//                 </div>
//               </div>
//             );
...
//               {/* Custom bubble visualization */}
//               <div className="absolute inset-0 flex items-center justify-center">
//                 <div className="relative">
//                   {/* Main red circle */}
//                   <div className="w-48 h-48 bg-red-500 rounded-full flex items-center justify-center relative">
//                     <div className="text-white text-center">
//                       <div className="text-4xl font-bold">3824</div>
//                     </div>
...
//                     {/* Small numbers */}
//                     <div className="absolute -bottom-2 left-8 text-white font-bold text-xl">541</div>
                    
//                     {/* Green small circle */}
//                     <div className="absolute -bottom-6 -left-6 w-12 h-12 bg-green-600 rounded-full flex items-center justify-center">
...
//                 <span className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Online</span>
//               </div>
//               <div className="flex items-center space-x-2">
//                 <div className="w-3 h-3 bg-green-600 rounded-full"></div>
//                 <span className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>New</span>
//               </div>
//               <div className="flex items-center space-x-2">
...
//                 <span className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>InActive</span>
//               </div>
//             </div>
//           </div>

//           {/* Enhanced SIP Business Chart */}
//           <div className={`p-6 rounded-lg shadow-sm transition-colors duration-300 ${
//             darkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'
//           }`}>
//             <div className="flex justify-between items-center mb-4">
